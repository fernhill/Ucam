...
void pollAlarms(){
  ...
  while(1){
    ...
    usleep(500000);
ecrt_master_sdo_upload(master0, 0, 0x603F,0x00, (unsigned char *)&value, sizeof(value), &resultSize, &abortCode);
sprintf(str1, "ERROR %u",value);
////printf("Value of 603F is %u\n",value);
